...
public class GameConstants {
  ...
  public static final String BABY_HERO_POWER_DESC = "Didn't do nuting";
  public static final String THAI_CHEF_HERO_POWER_DESC = "ATK_Opp_H(-2)";
  public static final String DANISH_CHEF_HERO_POWER_DESC = "Field-Sovs";

  public static final String FRENCH_CHEF_HERO_POWER_DESC = "Opp M: (0, -2)";

  public static final String ITALIAN_CHEF_HERO_POWER_DESC = "M: (+2, 0)";
}