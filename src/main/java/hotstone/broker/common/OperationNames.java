...
public class OperationNames {
  ...
  public static final String CARD_GET_EFFECT_DESCRIPTION = CARD_PREFIX + SEPARATOR + "get-effect-description";
  public static final String CARD_GET_ATTRIBUTE = CARD_PREFIX + SEPARATOR + "get-attribute";
  ...
  public static final String HERO_GET_POWER_DESCRIPTION = HERO_PREFIX + SEPARATOR + "get-power-description";
