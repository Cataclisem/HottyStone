...
public class ShowMinionFigureUpdate {
  ...
  public static void main(String[] args) {
    ...
    MinionFigure mf2 = new MinionFigure(deller, new Point(400,200));
  ...
  private static class UpdateMinionTool extends NullTool {
    private MinionFigure aMinionFigure;

    public UpdateMinionTool(DrawingEditor editor, MinionFigure aMinionFigure) {
