...
public class TestHeroBroker {
  ...
  public void setup() {
    ...
    hero = game.getHero(Player.FINDUS);
  }

  @Test
  public void shouldReturnCorrectHeroOwner() {
    Player owner = hero.getOwner();
    assertThat(owner, is(Player.FINDUS));
  }

  @Test
  public void shouldReturnCorrectHeroMana() {
    int mana = hero.getMana();
    assertThat(mana, is(2));
  }

  @Test
  public void shouldReturnCorrectHeroHealth() {
    int health = hero.getHealth();
    assertThat(health, is(21));
  }

  @Test
  public void shouldReturnCorrectHeroActiveness() {
    boolean active = hero.canUsePower();
    assertThat(active, is(true));
  }

  @Test
  public void shouldReturnCorrectHeroType() {
    String type = hero.getType();
    assertThat(type, is(GameConstants.BABY_HERO_TYPE));
  }
  @Test
  public void shouldReturnPowerDescription() {
    String desc = hero.getPowerDesc();
    assertThat(desc, is("Does-nothing"));
  }
}
